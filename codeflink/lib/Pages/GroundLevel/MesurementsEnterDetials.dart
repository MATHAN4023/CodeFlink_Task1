...
void main() {
  runApp(MaterialApp(
    home: MesurementsEnterDetials(),
  ));
}

class MesurementsEnterDetials extends StatefulWidget {
  const MesurementsEnterDetials({Key? key}) : super(key: key);

  @override
  State<MesurementsEnterDetials> createState() => _MesurementsEnterDetialsState();
}

class _MesurementsEnterDetialsState extends State<MesurementsEnterDetials> {
